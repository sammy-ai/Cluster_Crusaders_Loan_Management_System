    ...
    <nav class="flex-col bg-gray-900">
        <div class="w-full h-24 flex items-center">
            ...
            <div class="flex justify-center w-full">
                <span class="font-black text-3xl">Loans</span>
            </div>
            <div class="flex mr-4">
                <div class="">
    ...
    <div class="flex-col">
        <div class="flex w-full justify-center">
            <div class="rounded mx-4 flex bg-gray-400 w-5/6">
                <div class="flex w-1/3 justify-start text-gray-600 font-bold m-2">Loan List</div>
                <div class="w-2/3 flex justify-end m-2">
                    <button class="justify-end bg-blue-700 p-2 rounded">+ Create New Application</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex w-full justify-center text-gray-950 font-medium">
            <div class="border-t w-5/6 flex justify-end my-2 p-2 border-gray-400">
                <div class="">
                    ...
                    <input type="search" name="" id="" placeholder="search loans" class="p-2 font-normal rounded">
                </div>
            </div>
        </div>
            ...
            <table class="table-auto border-seperate border-spacing-2 border border-gray-700 rounded w-5/6">
                <thead>
                    <tr>
                        ...
                        <th class="">Next Payment Details</th>
                        <th class="">Status</th>
                        <th class="">Action</th>
                    </tr>
                </thead>
